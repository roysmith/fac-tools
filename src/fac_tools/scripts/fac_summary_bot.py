...
from fac_tools import Nomination, Revision, Index, FAToolsError, Article
...
def get_parsoid_html(article: Page) -> str:
    request = article.site.simple_request(
        action="parse",
        format="json",
        page=article.title(),
        parser="parsoid",
